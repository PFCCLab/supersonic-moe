# Directory Index: `/reports/paddle_compat_bench/`

> Directory for paddle compat bench.
...
| File | Summary | Notes |
| --- | --- | --- |
| `paddle_compat_20260416_200239.json` | JSON artifact with top-level keys: `timestamp`, `shapes`. | — |
