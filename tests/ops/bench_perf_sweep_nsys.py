...
# (E, N_recv, H, I)
SWEEP_SHAPES = [
    # H/I scaling (E=8, TK~65K)
    (8, 8192, 1536, 768), (8, 8192, 2048, 1024), (8, 8192, 3072, 1536),
    (8, 8192, 4096, 2048), (8, 8192, 4096, 4096), (8, 8192, 6144, 3072),
    # E scaling (H=3072, I=1536)
    (16, 4096, 3072, 1536), (32, 2048, 3072, 1536),
    (64, 1024, 3072, 1536), (128, 512, 3072, 1536),
    # TK scaling E=8
    (8, 2048, 3072, 1536), (8, 4096, 3072, 1536), (8, 16384, 3072, 1536),
    (8, 32768, 3072, 1536), (8, 65536, 3072, 1536), (8, 131072, 3072, 1536),
    (8, 262144, 3072, 1536),
    # TK scaling E=32
    (32, 4096, 3072, 1536), (32, 8192, 3072, 1536), (32, 16384, 3072, 1536),
    (32, 32768, 3072, 1536), (32, 65536, 3072, 1536), (32, 131072, 3072, 1536),
    # TK scaling E=128
    (128, 4096, 3072, 1536), (128, 8192, 3072, 1536), (128, 16384, 3072, 1536),
    (128, 32768, 3072, 1536), (128, 65536, 3072, 1536), (128, 131072, 3072, 1536),
    (128, 262144, 3072, 1536),
    # H/I scaling E=32
    (32, 2048, 2048, 1024), (32, 2048, 4096, 2048), (32, 2048, 4096, 4096),
    # H/I scaling E=128
    (128, 512, 2048, 1024), (128, 512, 4096, 2048),
]
