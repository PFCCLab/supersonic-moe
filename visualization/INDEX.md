...
| `path_compare_viz.py` | Renders the BF16-vs-FP8 frontier path and contribution comparison figures. | — |
...
| `sonicmoe_dataflow.py` | SonicMoE fig1–10: Session 53 data-driven figure suite. | — |
